...
const catalogSchema = new Schema(
    {
        title: {
            ...
            minLength: [
                2,
                "Catalogs's title must be at least 2 characters long!",
            ],
        },
        author: {
            type: String,
            ...
            minLength: [
                5,
                "Catalogs's author must be at least 5 characters long!",
            ],
        },
        genre: {
            type: String,
            ...
            minLength: [
                3,
                "Catalogs's genre must be at least 3 characters long!",
            ],
        },
        stars: {
            type: Number,
